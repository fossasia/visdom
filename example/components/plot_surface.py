...
def plot_surface_basic_withnames(viz, env):
...
def plot_surface_append_withnames(viz, env):
...
def plot_surface_remove_withnames(viz, env):
...
def plot_surface_replace_withnames(viz, env):
    plot_surface_replace(viz, env, True)

# contour
def plot_surface_contour(viz, env):
