...
def misc_plot_latex_update(viz, env):
...
def misc_video_download(viz, env):
    try:
        # video demo:
...
def misc_audio_download(viz, env):
    try:
...
def misc_arbitrary_visdom(viz, env):
