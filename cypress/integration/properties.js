...
describe('Properties Pane', () => {
  it('check download button', () => {
    ...
    cy.readFile(path.join(downloadsFolder, 'visdom_properties.json')).should(
      'exist'
    );
  });
