...
per handler (:func:`~visdom.utils.server_utils.check_readonly_message`), so what
needs testing is coverage rather than mechanism: each write endpoint refuses, each
