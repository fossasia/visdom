...
class VisdomLoggingHandler:
    def __init__(
        ...
        base_url: Text = ...,
        env: Text = ...,
        include_metrics: Optional[List[Text]] = ...,
        exclude_metrics: Optional[List[Text]] = ...,
        offline: bool = ...,
        log_to_filename: _OptStr = ...,
        viz: Optional[Visdom] = ...,
    ) -> None: ...
    def log(self, metrics: Mapping[Text, Any], step: Optional[int] = ...) -> None: ...
    def log_text(
        self, text: Text, win: _OptStr = ..., append: bool = ...
    ) -> _SendReturn: ...
    def log_image(
        self, img: Any, win: _OptStr = ..., opts: _OptOps = ...
    ) -> _SendReturn: ...
    @property
    def env(self) -> Text: ...
    @property
    def windows(self) -> Mapping[Text, Text]: ...
    def __enter__(self) -> "VisdomLoggingHandler": ...
